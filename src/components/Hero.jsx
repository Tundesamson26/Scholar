  ...
  return (
    <div className="w-full h-screen px-32 py-32">
      ...
      <div className="grid md:grid-cols-2 ">
        <div className="bg-[#F3EEE2] text-[#2B3035] mt-10 m-4 rounded-xl shadow-2xl">
          <div>
            <img
              className="w-full mt-[-5%] object-cover rounded-t-xl"
              src={stPeter}
              alt="/"
            />
            <h1 className="pt-8 text-center text-3xl font-bold text-[#2B3035]">
              St. Peters High School
            </h1>
            <button className="border-[#395241]  text-bold text-emarald-400 rounded-sm py-4 my-4 w-full text-center">
              Read more
            </button>
          </div>
          <div className="w-11/12 m-auto">
            ...
            <p className="py-1 mb-8 text-center text-[#2B3035]">
              $300 more to fund the next scholarships
            </p>
          </div>
...
{/*  */}
        <div className="bg-[#F3EEE2] text-[#2B3035] m-4 p-8 rounded-xl shadow-2xl">
          ...
          <div> 
            <button className="inline-block px-6 py-2.5 bg-[#395241] text-[#F3EEE2] font-bold text-xl leading-tight rounded shadow-md">
              Donate Now
            </button>
          </div>
        </div>
